/*   
  Symmetric version of the road traffic simulator for exploring Braess's paradox.
...
(function() {
  ...
  var ALink = new Link("A", north, dest);
  var bLink = new Link("b", orig, south);
  ...
  var aA = new Route();
  aA.label = "aA";
  aA.paintColor = "#cb0130";
  aA.directions = {"orig": aLink, "south": null, "north": ALink, "dest": parkingLot};
  aA.itinerary = [aLink, ALink];
  aA.calcRouteLength();
  ...
  var bA = new Route();
  bA.label = "bA";
  bA.paintColor = "#ffc526";
  bA.directions = {"orig": bLink, "south": snLink, "north": ALink, "dest": parkingLot};
  bA.itinerary = [bLink, snLink, ALink];
  bA.calcRouteLength();
  
  var bB = new Route();
  bB.label = "bB";
  bB.paintColor = "#4b9b55";
  bB.directions = {"orig": bLink, "south": BLink, "north": null, "dest": parkingLot};
  bB.itinerary = [bLink, BLink];
  bB.calcRouteLength();
  ...
  function chooseRoute() {
    var availableRoutes;
    if (bridgeBlocked) {
      availableRoutes = [aA, bB];
    }
    else {
      availableRoutes = [aA, aB, bA, bB];
    }
  ...
  var Dashboard = {
    ...
    arrivalCount: 0,
    counts: {
      "aA": 0, "aB": 0, "bA": 0, "bB": 0, "total": 0
    },
    times: {
      "aA": 0, "aB": 0, "bA": 0, "bB": 0, "total": 0
    },
    countReadouts:   {
    aA: document.getElementById("aA-count"),      // links to HTML table cells
    aB: document.getElementById("aB-count"),
    bA: document.getElementById("bA-count"),
    bB: document.getElementById("bB-count"),
    total: document.getElementById("total-count")
    },

    timeReadouts:   {
    aA: document.getElementById("aA-time"),
    aB: document.getElementById("aB-time"),
    bA: document.getElementById("bA-time"),
    bB: document.getElementById("bB-time"),
    total: document.getElementById("total-time")
    },
    
    colorize: function() {
      var aARow = document.getElementById("aA-row");    // make cell backgrounds match car colors
      aARow.style.backgroundColor = aA.paintColor;
      var aBRow = document.getElementById("aB-row");
      aBRow.style.backgroundColor = aB.paintColor;
      var bARow = document.getElementById("bA-row");
      bARow.style.backgroundColor = bA.paintColor;
      var bBRow = document.getElementById("bB-row");
      bBRow.style.backgroundColor = bB.paintColor;
